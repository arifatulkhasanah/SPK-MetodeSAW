...
<body id="page-top">
  ...
  <header class="masthead" style="height: 100vh;">
    <div class="container">
      <div class="intro-text" style="padding-top: 300px;
        padding-bottom: 200px;">
        <div class="intro-lead-in">Welcome to SAW Method!</div>
        <p>Metode Simple Additive Weighting (SAW) merupakan metode yang banyak digunakan dalam pengambilan keputusan yang memiliki banyak atribut. Metode Simple Additive Weighting (SAW) membutuhkan proses normalisasi matriks keputusan (x) ke suatu skala yang dapat diperbandingkan dengan semua rating alternatif yang ada. Oleh karena itu, pada aplikasi ini akan membahas tentang "Pemilihan Sepatu Sneakers" yang sesuai dengan kriteria yang diinginkan.</p>
        <br>
        <p> By Arifatul Khasanah-4611417016 </p>
      </div>
    </div>
  </header>
